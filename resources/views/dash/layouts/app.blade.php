...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- Favicon -->
        <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('assets/dash/img/apple-icon.png') }}">
        <link rel="icon" type="image/png" href="{{ asset('assets/dash/img/favicon.png') }}">
        <!-- Fonts -->
        <link href="https://fonts.googleapis.com/css?family=Poppins:200,300,400,600,700,800" rel="stylesheet" />
        <link href="https://use.fontawesome.com/releases/v5.0.6/css/all.css" rel="stylesheet">
        <!-- Icons -->
        <link href="{{ asset('assets/dash/css/nucleo-icons.css') }}" rel="stylesheet" />
        <!-- CSS -->
        <link href="{{ asset('assets/dash/css/black-dashboard.css?v=1.0.0') }}" rel="stylesheet" />
        <link href="{{ asset('assets/dash/css/theme.css') }}" rel="stylesheet" />
    </head>
    <body class="{{ $class ?? '' }}">
        @auth()
            <div class="wrapper">
                    @include('dash.layouts.navbars.sidebar')
                <div class="main-panel">
                    @include('dash.layouts.navbars.navbar')
        ...
        <script src="{{ asset('assets/dash/js/black-dashboard.min.js?v=1.0.0') }}"></script>
        <script src="{{ asset('assets/dash/js/theme.js') }}"></script>
